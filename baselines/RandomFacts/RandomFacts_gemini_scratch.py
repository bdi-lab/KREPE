...
def gemini_naive(num, fact_length, train_file, file_dir, output_path, model="gemini-3-pro-preview"):
    client = genai.Client()
...
if __name__ == "__main__":
    ...
    for dataset_name, fact_configs in datasets.items():
        ...
        output_filename = f"RandomFacts_gemini_scratch_{dataset_name}.txt"
