...
from mask_utils import load_masked_facts, load_train_facts, get_anchor_element, is_entity_position, has_mask 
...
if __name__ == "__main__":
    ...
    for dataset_name in datasets:
        ...
        output_filename = f"Autoregressive_gpt_arbi_{dataset_name}.txt"
